//Generated:2020-07-15 21:57:19// 6-239
(function(){
    var o = {
    $: function(el) {
        var x = el || o.divID, p = {
    ...
    (function() {
    var p = "4214891", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_4214891||'',
    guid:window.ftGUID_4214891||'',
    confID:window.ftConfID_4214891||'0',
    ftReturn: window.ftReturn_4214891||'',
    keyword:window.ftKeyword_4214891||'',
    ftId:window.ftId_4214891||'',
    ftImpId:window.ftImp4214891 && window.ftImp4214891.impID || '',
    campaignID: '115843',
    cID:'100966',
    pID:'4214891',
    creativeID:'2776215',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115843&sid=18330&plc=4214891&num=&adid=&advid=&adsrv=29&btreg=4214891&btadsrv=flashtalking&crt=2776215&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"],
    clickTags: ['http://servedby.flashtalking.com/click/8/115843;4214891;2776215;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/in/creativecloud/plans.html?plan=individual&sdid=GZKZY1B7&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?184123019-4214891;2776215;',
    centreAd: false,
    width:300,
    height:250,
    adType:'custom_rule'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/421/4214891/2776215/image/2776215.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115843;4214891;202;pixel;DV360;DV360FY20CCBEHCustomIntentCompetitiveINDSKBAN300x250/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/8/115843;4214891;2776215;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/in/creativecloud/plans.html?plan=individual&sdid=GZKZY1B7&mv=display',
    divID:'ftdiv4214891',
    altimgID:'ftalt4214891',
    alttext:'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4214891 && parseInt(window.ftImp4214891.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4214891') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m4214891'),
    pageVisible: 'maybe',
