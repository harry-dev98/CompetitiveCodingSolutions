...
function dv_baseHandler(){function A(b){try{var d=new URL(b);return!d.pathname||""==d.pathname||"/"==d.pathname}catch(f){}}function E(b){var d=window._dv_win,f=0;try{for(;10>f;){if(d[b]&&"object"===typeof d[b])return!0;if(d==d.parent)break;f++;d=d.parent}}catch(e){}return!1}function F(){var b="http:";"http:"!=window._dv_win.location.protocol&&(b="https:");return b}function B(b,d){var f=document.createElement("iframe");f.name=window._dv_win.dv_config.emptyIframeID||"iframe_"+w();f.width=0;f.height=
...
verRegex:null},{id:3,brRegex:"Chrome",verRegex:"Chrome/"},{id:5,brRegex:"Safari|(OS |OS X )[0-9].*AppleWebKit",verRegex:"Version/"}],f=0,e="",c=0;c<d.length;c++)if(null!=b.match(new RegExp(d[c].brRegex))){f=d[c].id;if(null==d[c].verRegex)break;b=b.match(new RegExp(d[c].verRegex+"[0-9]*"));null!=b&&(e=b[0].match(new RegExp(d[c].verRegex)),e=b[0].replace(e[0],""));break}d=V();4==f&&(d=f);return{ID:d,version:d===f?e:"",ID_UA:f}}function V(){try{if(null!=window._phantom||null!=window.callPhantom)return 99;
...
b==window.top){var r=c.querySelector('img[src*="dealsneartome.com"]')||(b.__cads__?!0:!1)||0<c.querySelectorAll('img[src*="/tracker?tag="]').length;e(28,17,r||!1)}return{f:d,s:f}}catch(h){return null}}function S(){try{var b=z(),d=0,f=b.document;b==window.top&&""==f.title&&!f.querySelector("meta[charset]")&&f.querySelector('div[style*="background-image: url("]')&&(f.querySelector('script[src*="j.pubcdn.net"]')||f.querySelector('span[class="ad-close"]'))&&(d+=Math.pow(2,6));return d}catch(e){return null}}
function T(){try{var b="&fcifrms="+window.top.length;window.history&&(b+="&brh="+window.history.length);var d=z(),f=d.document;if(d==window.top){b+="&fwc="+((d.FB?1:0)+(d.twttr?2:0)+(d.outbrain?4:0)+(d._taboola?8:0));try{f.cookie&&(b+="&fcl="+f.cookie.length)}catch(e){}d.performance&&d.performance.timing&&0<d.performance.timing.domainLookupStart&&0<d.performance.timing.domainLookupEnd&&(b+="&flt="+(d.performance.timing.domainLookupEnd-d.performance.timing.domainLookupStart));f.querySelectorAll&&(b+=
"&fec="+f.querySelectorAll("*").length)}return b}catch(e){return""}}this.createRequest=function(){var b=!1,d=window._dv_win,f=0,e=!1,c;try{for(c=0;10>=c;c++)if(null!=d.parent&&d.parent!=d)if(0<d.parent.location.toString().length)d=d.parent,f++,b=!0;else{b=!1;break}else{0==c&&(b=!0);break}}catch(v){b=!1}a:{try{var p=d.$sf;break a}catch(v){}p=void 0}if(0==d.document.referrer.length)b=d.location;else if(b)b=d.location;else{b=d.document.referrer;if(A(b)){a:{try{var k=d.$sf&&d.$sf.ext&&d.$sf.ext.hostURL&&
d.$sf.ext.hostURL();break a}catch(v){}k=void 0}if(k&&!A(k)&&0==k.indexOf(b)){b=k;var l=!0}}e=!0}if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};c=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1]:window._dv_win.dvbsScriptsInternal.pop();k=c.script;this.dv_script_obj=c;this.dv_script=k;window._dv_win.dvbsProcessed.push(c);
window._dv_win._dvScripts.push(k);var g=k.src;this.dvOther=0;this.dvStep=1;var r=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():w():w();c=window.parent.postMessage&&window.JSON;var h=!0,u=!1;if("0"==dv_GetParam(g,"t2te")||window._dv_win.dv_config&&1==window._dv_win.dv_config.supressT2T)u=!0;if(c&&0==u)try{var q=B(window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html",
"bst2t_"+r);h=x(q)}catch(v){}q={};try{u=/[\?&]([^&]*)=([^&#]*)/gi;for(var m=u.exec(g);null!=m;)"eparams"!==m[1]&&(q[m[1]]=m[2]),m=u.exec(g);var n=q}catch(v){n=q}n.perf=this.perf;n.uid=r;n.script=this.dv_script;n.callbackName="__verify_callback_"+n.uid;n.tagObjectCallbackName="__tagObject_callback_"+n.uid;n.tagAdtag=null;n.tagPassback=null;n.tagIntegrityFlag="";n.tagHasPassbackFlag="";0==(null!=n.tagformat&&"2"==n.tagformat)&&(m=J(n.script),n.tagAdtag=m.tagAdTag,n.tagPassback=m.tagPassback,m.isBadImp?
n.tagIntegrityFlag="&isbadimp=1":m.hasPassback&&(n.tagHasPassbackFlag="&tagpb=1"));(m=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream)?q="https:":(q=n.script.src,g="http:",r=window._dv_win.location.toString().match("^http(?:s)?"),"https"!=q.match("^https")||"https"!=r&&"http"==r||(g="https:"),q=g);n.protocol=q;n.ssl="0";"https:"===n.protocol&&(n.ssl="1");q=n;(g=window._dv_win.dvRecoveryObj)?
("2"!=q.tagformat&&(g=g[q.ctx]?g[q.ctx].RecoveryTagID:g._fallback_?g._fallback_.RecoveryTagID:1,1===g&&q.tagAdtag?document.write(q.tagAdtag):2===g&&q.tagPassback&&document.write(q.tagPassback)),q=!0):q=!1;if(q)return{isSev1:!0};this.dvStep=2;I(n,m);k=k&&k.parentElement&&k.parentElement.tagName&&"HEAD"===k.parentElement.tagName;this.dvStep=3;return D(this,n,b,d,f,e,c,h,k,m,l,p)};this.sendRequest=function(b){var d=dv_GetParam(b,"tagformat");d&&"2"==d?$dvbs.domUtilities.addScriptResource(b,document.body):
dv_sendScriptRequest(b);try{if("1"!=dv_GetParam(b,"foie")){var f=G(this.dv_script_obj&&this.dv_script_obj.injScripts),e=B("about:blank");e.id=e.name;var c=e.id.replace("iframe_","");e.setAttribute&&e.setAttribute("data-dv-frm",c);x(e,this.dv_script);if(this.dv_script){var p=this.dv_script;a:{b=null;try{if(b=e.contentWindow){var k=b;break a}}catch(h){}try{if(b=window._dv_win.frames&&window._dv_win.frames[e.name]){k=b;break a}}catch(h){}k=null}p.dvFrmWin=k}a:{var l;if(e&&(l=e.contentDocument||e.contentWindow&&
e.contentWindow.document)){var g=l;break a}g=(l=window._dv_win.frames&&window._dv_win.frames[e.name]&&window._dv_win.frames[e.name].document)?l:null}if(g)g.open(),g.write(f);else{try{document.domain=document.domain}catch(h){}var r=encodeURIComponent(f.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));e.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+r+"');})()"}}}catch(h){f=(window._dv_win.dv_config=window._dv_win.dv_config||{}).tpsAddress||
"rtb0.doubleverify.com",e=[this.getVersionParamName(),this.getVersion()].join("="),f+=["/verify.js?ctx=818052&cmp=1619415&num=6",e].join("&"),dv_SendErrorImp(f,[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(h)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=D);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"127"}};
